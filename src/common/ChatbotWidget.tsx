...
export default function ChatbotWidget() {
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none">
      ...
      <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 flex flex-col gap-3 pointer-events-auto">
        {/* Floating Button */}
        <button
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mx-auto sm:mx-0 sm:absolute sm:bottom-20 sm:right-6 w-[95vw] sm:w-[360px] min-h-[300px] max-h-[80vh] bg-white rounded-2xl shadow-2xl flex flex-col border border-gray-200 overflow-hidden pointer-events-auto"
          >
            {/* Header */}
