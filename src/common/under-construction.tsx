...
const UnderConstruction = () => {
  return (
    <div className="flex h-[100svh] w-full flex-col items-center justify-between bg-secondary">
      <div className="flex flex-1 flex-col items-center justify-center px-4 text-center lg:px-0 xl:w-1/2">
        ...
        <p className="mt-8 font-bold text-4xl text-secondary-content capitalize tracking-wide">
          Website under development!
        </p>
        <p className="mt-4 text-secondary-content text-xl uppercase">
          We'll be up soon
        </p>
      </div>
      <div className="w-full border-gray-300 border-t py-4">
        <div className="container mx-auto flex flex-col items-center justify-center space-y-1 text-gray-600 text-sm md:flex-row md:space-x-8 md:space-y-0">
