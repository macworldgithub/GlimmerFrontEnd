      ...
      isButtonDisabled
        ...
        : "border-purple-800 hover:border-purple-800 hover:text-purple-800"
            ...
            <button
              ...
              className="flex-1 w-full h-12 xl:px-6 text-xs bg-[#583FA8] text-white font-semibold rounded-md hover:bg-purple-900"
            >
              BULK BUY
            </button>
            {isBulkModalOpen && (
