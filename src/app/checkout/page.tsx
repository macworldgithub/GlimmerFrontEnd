...
//     // Validate productList before sending
//     const validProductList = cart.ProductList.map((productItem) => {
//       // Filter out invalid type entries
//       const validTypes = productItem.product.type
//         .filter((t) => t.value && t.value !== "-") // Remove entries with empty or "-" values
//         .map((t) => ({
//           id: t.id || "",
//           value: t.value || "DefaultType", // Fallback to a valid default if needed
//         }));
...
//           type: validTypes.length > 0 ? validTypes : [{ id: "", value: "DefaultType" }], // Ensure at least one valid type
...
//     // Check if all products have valid types
...
//       customerCNIC: "4250156667561", // Consider adding this to the form
//     };
