...
const OfferPictures = () => {
  return (
    <div className="w-full py-10 ml-28">
  <div className="max-w-7xl mx-auto px-4">
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
      ...
      <div className="bg-[#D9D9D9] rounded-lg shadow-md flex h-[320px] w-full overflow-hidden">
        ...
        <div className="w-1/2 p-4 flex flex-col justify-center items-start bg-[#4B2994]">
      ...
      <div className="bg-[#D9D9D9] rounded-lg shadow-md flex h-[320px] w-full overflow-hidden">
        <div className="w-1/2 p-4 flex flex-col justify-center items-start bg-[#4B2994]">
          ...
          <button className="mt-2 bg-white text-[#4B2994] text-sm px-3 py-1 rounded">
